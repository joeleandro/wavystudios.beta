...
import { validarHorasParaSessao } from '@/lib/horas/validar'
...
export async function POST(req: NextRequest) {
  ...
  // Check weekly/cycle hours (dynamic — no horas_semana table)
  const validacao = await validarHorasParaSessao(supabase, targetId, duracao, dataStr)
  if (!validacao.ok) {
